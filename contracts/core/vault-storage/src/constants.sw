...
pub const FUNDING_RATE_PRECISION: u256 = 1000000;
pub const PRICE_PRECISION: u256 = 0xC9F2C9CD04674EDEA40000000u256; // 10 ** 30;
pub const MIN_LEVERAGE: u64 = 10000; // 1x
pub const RUSD_DECIMALS: u8 = 8;
...
pub const MIN_FUNDING_RATE_INTERVAL: u64 = 3600; // 1 hour
pub const MAX_FUNDING_RATE_FACTOR: u64 = 10000; // 1%