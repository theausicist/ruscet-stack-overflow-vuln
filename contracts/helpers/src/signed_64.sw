...
impl core::ops::Add for Signed64 {
    ...
    fn add(self, other: Self) -> Self {
        if !self.is_neg && !other.is_neg {
            ...
            require(false, "Signed64Error: addition overflow");
            revert(0);
        }
    }
}
...
impl core::ops::Subtract for Signed64 {
    ...
    fn subtract(self, other: Self) -> Self {
        if self == other { Self::new() }
            ...
            require(false, "Signed64Error: subtraction overflow");
            revert(0);
        }
    }
}
...
impl core::ops::Multiply for Signed64 {
    ...
    fn multiply(self, other: Self) -> Self {
        if self.value == 0 || other.value == 0{
            ...
            require(false, "Signed64Error: multiplication overflow");
            revert(0);
        }
    }
}
...
impl core::ops::Divide for Signed64 {
    ...
    fn divide(self, divisor: Self) -> Self {
        ...
        if self.value == 0{
            ...
            require(false, "Signed64Error: division overflow");
            revert(0);
        }
    }
}
