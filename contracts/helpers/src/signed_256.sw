...
impl From<u256> for Signed256 {
    ...
    fn into(self) -> u256 {
        if !self.is_neg {
            ...
            require(false, "Signed256Error: cannot fit i256 into u256");
            revert(0);
        }
    }
}
...
impl core::ops::Add for Signed256 {
    ...
    fn add(self, other: Self) -> Self {
        if !self.is_neg && !other.is_neg {
            ...
            require(false, "Signed256Error: addition overflow");
            revert(0);
        }
    }
}
...
impl core::ops::Subtract for Signed256 {
    ...
    fn subtract(self, other: Self) -> Self {
        if self == other { Self::new() }
            ...
            require(false, "Signed256Error: subtraction overflow");
            revert(0);
        }
    }
}
...
impl core::ops::Multiply for Signed256 {
    ...
    fn multiply(self, other: Self) -> Self {
        if self.value == 0 || other.value == 0{
            ...
            require(false, "Signed256Error: multiplication overflow");
            revert(0);
        }
    }
}
...
impl core::ops::Divide for Signed256 {
    ...
    fn divide(self, divisor: Self) -> Self {
        ...
        if self.value == 0{
            ...
            require(false, "Signed256Error: division overflow");
            revert(0);
        }
    }
}
