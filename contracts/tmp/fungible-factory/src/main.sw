...
impl FungibleAssetFactory for Contract {
    /*
    ...
    */
    ...
    fn burn(sub_id: SubId, amount: u64) {
        ...
        require(
            ...
            Error::FungibleFactoryBurnInsufficientAssetForwarded,
        );
        require(
            msg_amount() == amount,
            Error::FungibleFactoryBurnInsufficientAmountForwarded,
        );
    ...
    fn set_name(asset_id: AssetId, name: String) {
        require(
            storage
                ...
                .read_slice()
                .is_none(),
            Error::FungibleFactoryNameAlreadySet,
        );
    ...
    fn set_symbol(asset_id: AssetId, symbol: String) {
        require(
            storage
                ...
                .read_slice()
                .is_none(),
            Error::FungibleFactorySymbolAlreadySet,
        );
    ...
    fn set_decimals(asset_id: AssetId, decimals: u8) {
        require(
            storage
                ...
                .try_read()
                .is_none(),
            Error::FungibleFactoryDecimalsAlreadySet,
        );
    ...
    */
    ...
    fn transfer(to: Identity, sub_id: SubId, amount: u64) {
        ...
        require(
            amount == msg_amount(),
            Error::FungibleFactoryInsufficientAmountForwarded
        );
    ...
    fn transfer_to_address(to: Address, sub_id: SubId, amount: u64) {
        ...
        require(
            ...
            Error::FungibleFactoryInsufficientAssetForwarded
        );
    ...
    /*
       ...
       /_/_/    |_|  |_|_|___/\___|
    */
    fn get_asset_id(sub_id: b256) -> AssetId {
